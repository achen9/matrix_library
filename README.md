...
## Contents
1.     Getting Started
  1.   Installing the Rust Compiler and Cargo Package Manager
  2.   Cloning the Library from the Repository 
  3.   Using the Library 
  4.   Running Unit Tests 
2.     Library Content Documentation 
  1.   Fraction Class
    1. Fraction Class Methods
    2. Fraction Class Arithmetic Operator Overloads
    3. Fraction Class Comparison Operator Overloads
    4. Printing Fractions to Stdout
  2.   Complex Class
    1. Complex Class Methods
    2. Complex Class Arithmetic Operator Overloads
    3. Complex Class Comparison Operator Overloads
    4. Printing Complex Numbers to Stdout 
  3.   Matrix Class Generic
  4.   Discrete Fourier Transform (DFT) Class
