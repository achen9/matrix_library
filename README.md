...
```
#### Matrix Named Constructors
Named constructors are provided to create commonly used matrices.
```rust
...
let o: Matrix<f64> = ones(2, 3); // create a 2x3 ones matrix
let r: Matrix<f64> = random(2, 4); // create a 2x4 random matrix
```
#### Matrix Getters
